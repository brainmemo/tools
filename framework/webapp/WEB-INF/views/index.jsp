    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="<c:url value="/resources/assets/images/logo.svg"/>" alt="logo"></a>
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"> <img alt="logo" src="<c:url value="/resources/assets/images/logo-mini.svg" />"></a>
        </div>
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              <div class="nav-profile-image">
              <img alt="profile"  src="<c:url value="/resources/assets/images/face1.jpg" />">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<c:url value="/resources/pages/ui-features/buttons.html"/>">Buttons</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<c:url value="/resources/pages/ui-features/dropdowns.html"/>">Dropdowns</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<c:url value="/resources/pages/ui-features/typography.html"/>">Typography</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value="/resources/pages/icons/mdi.html"/>">
              <i class="mdi mdi-contacts menu-icon"></i>
              <span class="menu-title">Icons</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value="/resources/pages/forms/basic_elements.html"/>">
              <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              <span class="menu-title">Forms</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value="/resources/pages/charts/chartjs.html"/>">
              <i class="mdi mdi-chart-bar menu-icon"></i>
              <span class="menu-title">Charts</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<c:url value="/resources/pages/tables/basic-table.html"/>">
      ...
      <div class="container-fluid page-body-wrapper">
        <div id="theme-settings" class="settings-panel">
          ...
          <div class="sidebar-bg-options selected" id="sidebar-default-theme">
            <div class="img-ss rounded-circle bg-light border mr-3"></div> Default Krishan
          </div>
          <div class="sidebar-bg-options" id="sidebar-dark-theme">
            <div class="img-ss rounded-circle bg-dark border mr-3">DAE</div> Dark ABC
          </div>
        ...
        <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
          <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
            <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="index.html"><img src="<c:url value="/resources/assets/images/logo-mini.svg"/> alt="logo" >/></a>
                ...
                <div class="dropdown-menu navbar-dropdown navbar-dropdown-large preview-list" aria-labelledby="notificationDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="<c:url value="/resources/assets/images/faces/face4.jpg"/>" alt="" class="profile-pic">
                    </div>
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="<c:url value="/resources/assets/images/faces/face3.jpg"/>" alt="" class="profile-pic">
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="<c:url value="/resources/assets/images/faces/face2.jpg"/>" alt="" class="profile-pic">
                    </div>
                    <div class="preview-item-content">
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  <img class="nav-profile-img mr-2" src="<c:url value="/resources/assets/images/faces/face1.jpg"/>" alt="profile">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <img alt="image"  src="<c:url value="/resources/assets/images/face1.jpg"/>" >
                                <div class="table-user-name ml-3">
                                  <p class="mb-0 font-weight-medium"> Cecelia A Cooper </p>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="<c:url value="/resources/assets/images/faces/face10.jpg"/>" alt="image">
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="<c:url value="/resources/assets/images/faces/face11.jpg"/>" alt="image">
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="<c:url value="/resources/assets/images/faces/face13.jpg"/>" alt="image">
                                <div class="table-user-name ml-3">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="<c:url value="/resources/assets/images/faces/face16.jpg"/>" alt="image">
                                <div class="table-user-name ml-3">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                      <img class="survey-img mb-lg-3" src="<c:url value="/resources/assets/images/dashboard/img_3.jpg"/>" alt="">
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="<c:url value="/resources/assets/images/dashboard/img_1.jpg"/>" alt="">
                      <div class="pt-2">
                    ...
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="<c:url value="/resources/assets/images/dashboard/img_2.jpg"/>" alt="">
                      <div class="pt-2">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-12 col-sm-7">
                        <div class="row">
                          <div class="col-4 col-md-4">
                            <img class="customer-img" src="<c:url value="/resources/assets/images/faces/face22.jpg"/>" alt=""> 
                          </div>
                      ...
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="<c:url value="/resources/assets/images/faces/face25.jpg"/>" alt="">
                          </div>
                    ...
                    <div class="row py-1">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="<c:url value="/resources/assets/images/faces/face15.jpg"/>" alt="">
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row py-1">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="<c:url value="/resources/assets/images/faces/face5.jpg"/>" alt="">
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                    ...
                    <div class="row">
                      <div class="col-sm-7">
                        <div class="row">
                          <div class="col-4 col-sm-4">
                            <img class="customer-img" src="<c:url value="/resources/assets/images/faces/face2.jpg"/>" alt="" />
                          </div>
                          <div class="col-8 col-sm-8 p-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="<c:url value="/resources/assets/images/dashboard/img_4.jpg"/>" alt="">
                          <div class="pl-2">
                    ...
                    <div class="row py-3 align-items-center mx-0">
                      <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                          <img src="<c:url value="/resources/assets/images/dashboard/img_5.jpg"/>" alt="">
                          <div class="pl-2">
                        ...
                        <p class="text-muted">
                          ...
                          <span class="d-inline-block">
                            <span class="d-flex d-inline-block">
                              ...
                              <img class="ml-1" src="<c:url value="/resources/assets/images/face1.jpg" />" alt="">
                              <img class="ml-1" src="<c:url value="/resources/assets/images/faces/face10.jpg"/>" alt="" >
                              <img class="ml-1" src="<c:url value="/resources/assets/images/faces/face14.jpg"/>" alt="" >
                            </span>
                          </span>
                        </p>
                      </li>
                        ...
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              ...
                              <img src="<c:url value="/resources/assets/images/faces/face2.jpg"/>" alt="" >
                            </div>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="<c:url value="/resources/assets/images/faces/face3.jpg"/>" alt="" >
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="<c:url value="/resources/assets/images/faces/face11.jpg"/>" alt="" >
                            </div>
                            <div class="col-sm-8 pr-0 pl-sm-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="<c:url value="/resources/assets/images/browser-logo/opera-logo.png"/>" alt="">
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="<c:url value="/resources/assets/images/browser-logo/safari-logo.png"/>" alt="">
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="<c:url value="/resources/assets/images/browser-logo/chrome-logo.png"/>" alt="" >
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                          <div>
                            <img class="mr-2" src="<c:url value="/resources/assets/images/browser-logo/firefox-logo.png"/>" alt="">
                    ...
                    <div class="row py-2">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                          <div>
                            <img class="mr-2" src="<c:url value="/resources/assets/images/browser-logo/explorer-logo.png"/>" alt="" >
